...
ninetydays <- rapbase::loadRegData("ethirgast", "SELECT * FROM ninetydays")
patient <- rapbase::loadRegData("ethirgast", "SELECT * FROM patient")
readmission <- rapbase::loadRegData("ethirgast", "SELECT * FROM readmission")
registration <- rapbase::loadRegData("ethirgast", "SELECT * FROM registration")
